...
public class JULTestTest {

    // 快速入门
    @Test
    public void testQuick()throws Exception{
        // 1.获取日志记录器对象
        Logger logger = Logger.getLogger("com.xhjc.java.jul.JULTestTest");
        // 2.日志记录输出
    ...
    public void testLogParent()throws Exception{
        ...
        Logger logger1 = Logger.getLogger("com.xhjc.java.jul");
...
//        // 读取配置文件，通过类加载器
        ...
        // 创建日志记录器
        Logger logger = Logger.getLogger("com.xhjc");
